...
export function LabSection() {
  ...
  return (
    <SectionShell ref={ref} meta={SECTIONS[3]}>
      ...
      <div data-reveal className="mt-16 text-center font-mono text-xs leading-loose tracking-[.2em] text-fg-dim uppercase">EXPERIMENTS COMPLETE<br/>SOME WORKED / SOME FAILED / SOME ARE STILL RUNNING<br/><span className="text-fg">THAT&apos;S HOW BUILDING WORKS</span><br/><a href="#journey" className="text-neon-cyan underline">RETURNING TO MAIN SYSTEM → JOURNEY</a></div>
